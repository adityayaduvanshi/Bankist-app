...
const account2 = {
  ...
  movementsDates: [
    ...
    '2021-06-27T18:49:59.371Z',
    '2021-06-29T12:01:20.894Z',
  ],
  currency: 'USD',
  locale: 'en-US',
};
const account3 = {
  owner: 'Pranjul Yaduvanshi',
  movements: [2000, -2000, 3400, -300, -20, 5000, 4000, -460],
  interestRate: 0.7,
  pin: 3333,
  ...
  movementsDates: [
    ...
    '2021-01-25T14:18:46.235Z',
    '2021-02-05T16:33:06.386Z',
    '2021-04-24T14:43:26.374Z',
    '2021-06-26T18:49:59.371Z',
    '2021-06-28T12:01:20.894Z',
  ],
  currency: 'INR',
  locale: 'en-IN',
};
...
btnLogin.addEventListener('click', function (e) {
  ...
  if (thehours >= 5 && thehours < 12) {
    ...
    themessage = 'Good Night';
  } else if (thehours >= 0 && thehours < 5) {
    themessage = 'Good Night';
  }
  if (currentAccount?.pin === Number(inputLoginPin.value)) {
    // Display UI and message
    labelWelcome.textContent = `${themessage}, ${
